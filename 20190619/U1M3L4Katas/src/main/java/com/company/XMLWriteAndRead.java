...
public class XMLWriteAndRead {
    public static void main(String[] args) {
        ...
        try {
            ...
            writer = new PrintWriter(new FileWriter("carList.xml")); //Change to .json to write JSON files

            writer.println(jsonCarsList);

            carsList = mapper.readValue(new File("carsList.xml"), new TypeReference<List<Car>>() {
            });
